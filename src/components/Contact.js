...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "DFmqWwcw59uqNsIYW", // Replace with your EmailJS service ID
        "template_mlv5g62", // Replace with your EmailJS template ID
        form.current,
        "DFmqWwcw59uqNsIYW" // Replace with your EmailJS user ID
      )
      .then(
        (result) => {
